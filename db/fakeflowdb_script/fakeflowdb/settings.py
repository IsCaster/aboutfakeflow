# Django settings for fakeflowdb project.
...
# system time zone.
TIME_ZONE = 'Asia/Hong_Kong Hongkong'
...
SECRET_KEY = 'b#h&amp;*dy)f1jf_a+jtyt013*_lr*0w05jut!=313un0czuh()bp'
...
ROOT_URLCONF = 'fakeflowdb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fakeflowdb.wsgi.application'
